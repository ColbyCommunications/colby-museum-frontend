    ...
    <div class="page page--default">
        <div class="search-results__inner grid">
            <div class="search-results__secondary">
                ...
                <Btn :title="'Search the Collection'" :url="'/objects'" />
            </div>
        </div>
            ...
            <div class="search-results__inner grid">
                <div class="search-results__main">
                    ...
                    <Article
                        ...
                        :heading="item.title"
                        :subheading="
                            item.url.replace(/^.*\/\/[^\/]+/, 'museum.colby.edu').replace(/\/$/, '')
                        "
            ...
            <div class="pagination__inner grid">
                <div class="pagination__main">
                    <NuxtLink
                        ...
                        :to="`/search?page=${Number($route.query.page) - 1}&search=${
                            $route.query.search
                        }`"
                    ...
                    <NuxtLink
                        ...
                        :class="[
                            $route.query.page == Number(totalPages)
