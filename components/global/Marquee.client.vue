<template>
    <div class="marquee" tabindex="0">
        <div class="marquee__rail-wrap" ref="marqueeWrap" v-resize:debounce="calculateWidth">
            <div class="marquee__rail marquee__rail-1" ref="marqueeOriginal">
                <span
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            animate() {
                this.marqueeAnimation = gsap.fromTo(
                    this.$refs.marqueeWrap,
                    Number(this.speed),
                    {
                        x: 0,
                        ease: 'none',
